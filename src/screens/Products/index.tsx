...
const Product: React.FC = () => {
  ...
  const renderFooterList = () => {
    ...
    return <ActivityIndicator animating={true} color="#007cc3" size="large" />;
  };
  return (
    <Container>
      <StatusBar barStyle="light-content" backgroundColor="#007cc3" />
      <Header
      ...
      />
      {loading ? (
        <ActivityIndicator animating={true} color="#007cc3" size="large" />
      ) : (
        <>
          <Modal
            animationType="slide"
